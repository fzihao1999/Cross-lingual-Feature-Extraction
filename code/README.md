...
python map_embeddings.py --unsupervised ../data/wiki_data/vec/en.vec ../data/wiki_data/vec/vi.vec ../data/wiki_data/en-vi/en.mapped.vec ../data/wiki_data/en-vi/vi.mapped.vec --src_semvec ../data/wiki_data/sem_vec/en_sem.vec --trg_semvec ../data/wiki_data/sem_vec/vi_sem.vec --validation ../data/wiki_data/crosslingual/dictionaries/en-vi.5000-6500.txt  --verbose --log ../data/wiki_data/en-vi/en-vi
```
