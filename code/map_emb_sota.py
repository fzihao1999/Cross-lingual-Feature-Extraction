...
def main():
    ...
    if args.src_semvec is not None:
        src_words, x = embeddings.combine(src_words_pre, src_words_sem, x_pre, x_sem, src_word2ind_sem, dim, dtype=dtype)
        trg_words, z = embeddings.combine(trg_words_pre, trg_words_sem, z_pre, z_sem, trg_word2ind_sem, dim, dtype=dtype)
    else:
        src_words, x = src_words_pre, x_pre
        trg_words, z = trg_words_pre, z_pre
