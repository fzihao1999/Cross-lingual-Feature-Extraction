...
def main():
    ...
    parser.add_argument('--src_semvec', help='the random seed (defaults to 0)')
    parser.add_argument('--trg_semvec', help='the random seed (defaults to 0)')
    parser.add_argument('--sem_dim', help='the random seed (defaults to 0)')
    parser.add_argument('--add_mat', help='the random seed (defaults to 0)')
